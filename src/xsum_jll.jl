...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import xsum_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("e979a739-315a-50ee-b437-b496a9503be1"))
platforms = [Pkg.Artifacts.unpack_platform(e, "xsum", artifacts_toml) for e in artifacts["xsum"]]
...
if best_platform === nothing
    @debug("Unable to load xsum; unsupported platform $(triplet(platform_key_abi()))")
else
